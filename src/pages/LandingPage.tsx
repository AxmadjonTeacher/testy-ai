  ...
  return <div className="min-h-screen bg-background">
      ...
      <section className="container mx-auto px-4 py-20 max-w-6xl">
        ...
        duration: 0.6
          ...
          <Button onClick={() => navigate('/generate')} className="h-14 px-8 text-lg font-bold bg-accent text-accent-foreground border-4 border-foreground neo-shadow hover:translate-x-[2px] hover:translate-y-[2px] hover:shadow-none transition-all">
      ...
      {/* Testimonial Section */}
      <section className="container mx-auto px-4 py-20 max-w-6xl">
        <motion.div className="bg-secondary border-4 border-foreground p-12 neo-shadow-lg text-center" initial={{
        opacity: 0,
        scale: 0.95
      }} whileInView={{
        opacity: 1,
        ...
        once: true
          ...
          <p className="text-sm font-medium">- Otabek Teacher, IELTS Instructor at Al-Xorazmiy School</p>
        </motion.div>
      </section>
